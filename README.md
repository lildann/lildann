...
| ---------------------------- | ----------------- | ----------------- | ----------|
| **[Rock Paper Scissor](https://github.com/lildann/rock-paper-scissor)** | [Rock Paper Scissor game](https://stark-wildwood-21335.herokuapp.com/) deployed on Heroku | solo-project | Ruby, Sinatra, RSpec, Capybara, HTML, CSS, Heroku |
